...
hm() {
    ...
    python7 -m compressai.utils.bench hm "$dataset"             \
...
vtm() {
    ...
    python7 -m compressai.utils.bench vtm "$dataset"            \
...
av1() {
    ...
    python7 -m compressai.utils.bench av1 "$dataset"            \
...
tfci() {
    ...
    python7 -m compressai.utils.bench tfci "$dataset"           \
